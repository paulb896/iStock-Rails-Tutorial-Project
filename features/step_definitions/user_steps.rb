...
Then /^I should see a confirmation that says "(.*?)"$/ do |arg1|
  pending # express the regexp above with the code you wish you had
end

Then /^then a user should exist with the username "(.*?)"$/ do |arg1|
  pending # express the regexp above with the code you wish you had
end
...
Then /^then a user should exist with the username "(.*?)", the email "(.*?)" and the password "(.*?)"$/ do |arg1, arg2, arg3|
  pending # express the regexp above with the code you wish you had
end
